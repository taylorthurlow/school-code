...
public class State {
  ...
  public int playerUtility() {
    return (utility(true) - utility(false));
  }

  private int utility(boolean player) {
    int points = 0;
  ...
  public ArrayList<State> successors(boolean player) {
  ...
  public boolean childOf(State state, boolean player) {
    int differences = 0;
